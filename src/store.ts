...
export const internalAccounts: InternalAccount[] = [
  { id: "mgr1", accountId: "faisal.manager", password: "fm12345", name: "Mehrab", roles: ["Manager"] },
  { id: "tech1", accountId: "rashed.tech", password: "fm12345", name: "Rashed", roles: ["Technician"] },
  { id: "tech2", accountId: "nila.tech", password: "fm12345", name: "Nila", roles: ["Technician"] },
  { id: "admin1", accountId: "FM", password: "1111", name: "FM Team", roles: ["Admin"] },
  { id: "farhad", accountId: "farhad.manager", password: "fm12345", name: "Farhad", roles: ["Manager"] },
  { id: "manna", accountId: "manna.tech", password: "fm12345", name: "Manna", roles: ["Technician", "Stock Maintenance", "After-Sales Support"] },
  { id: "alamin", accountId: "alamin.manager", password: "fm12345", name: "Al Amin", roles: ["Manager"] },
  { id: "shaon", accountId: "shaon.service", password: "fm12345", name: "Shaon", roles: ["Manager", "Head of Service"] },
  { id: "liton", accountId: "liton.tech", password: "fm12345", name: "Liton", roles: ["Technician"] },
  { id: "bashu", accountId: "bashu.tech", password: "fm12345", name: "Bashu", roles: ["Technician"] },
  { id: "hares", accountId: "hares.mechanic", password: "fm12345", name: "Hares", roles: ["Technician", "Senior Mechanic"] },
  { id: "jashim", accountId: "jashim.mechanic", password: "fm12345", name: "Jashim", roles: ["Technician", "Senior Mechanic"] },
  { id: "selim", accountId: "selim.tech", password: "fm12345", name: "Selim", roles: ["Technician"] },
  { id: "farid", accountId: "farid.tech", password: "fm12345", name: "Farid", roles: ["Technician"] },
  { id: "noyon", accountId: "noyon.tech", password: "fm12345", name: "Noyon", roles: ["Technician"] },
  { id: "arman", accountId: "arman.office", password: "fm12345", name: "Arman", roles: ["Admin", "Office Manager"] },
  { id: "abdurrahim", accountId: "abdurrahim.accounts", password: "fm12345", name: "Abdur Rahim", roles: ["Admin", "Stocks and Accounts"] },
  { id: "riyad", accountId: "riyad.repairs", password: "fm12345", name: "Riyad", roles: ["Technician", "Repairs"] },
  { id: "mehedi", accountId: "mehedi.tech", password: "fm12345", name: "Mehedi", roles: ["Technician"] },
  { id: "hena", accountId: "hena.tech", password: "fm12345", name: "Hena", roles: ["Technician", "Marketing"] },
  { id: "rafin", accountId: "rafin.tech", password: "fm12345", name: "Rafin", roles: ["Technician", "Marketing"] },
  { id: "luke", accountId: "luke.tech", password: "fm12345", name: "Luke", roles: ["Technician"] },
];
