...
export const internalAccounts: InternalAccount[] = [
  { id: "mgr1", accountId: "faisal.manager", password: "2222", name: "Mehrab", roles: ["Manager", "Software Team", "Hardware Team"] },
  { id: "tech1", accountId: "rashed.tech", password: "2222", name: "Rashed", roles: ["Technician", "Hardware Team"] },
  { id: "tech2", accountId: "nila.tech", password: "2222", name: "Nila", roles: ["Technician", "Hardware Team"] },
  { id: "admin1", accountId: "FM", password: "2222", name: "Lucy", roles: ["Admin", "GM", "Software Team"] },
  { id: "farhad", accountId: "farhad.manager", password: "2222", name: "Farhad", roles: ["Manager", "Hardware Team"] },
  { id: "manna", accountId: "manna.tech", password: "2222", name: "Manna", roles: ["Technician", "Stock Maintenance", "After-Sales Support", "Hardware Team"] },
  { id: "alamin", accountId: "alamin.manager", password: "2222", name: "Al Amin", roles: ["Manager", "Hardware Team"] },
  { id: "shaon", accountId: "shaon.service", password: "2222", name: "Shaon", roles: ["Manager", "Head of Service", "Hardware Team"] },
  { id: "liton", accountId: "liton.tech", password: "2222", name: "Liton", roles: ["Technician", "Hardware Team"] },
  { id: "bashu", accountId: "bashu.tech", password: "2222", name: "Bashu", roles: ["Technician", "Hardware Team"] },
  { id: "hares", accountId: "hares.mechanic", password: "2222", name: "Hares", roles: ["Technician", "Senior Mechanic", "Hardware Team"] },
  { id: "jashim", accountId: "jashim.mechanic", password: "2222", name: "Jashim", roles: ["Technician", "Senior Mechanic", "Hardware Team"] },
  { id: "selim", accountId: "selim.tech", password: "2222", name: "Selim", roles: ["Technician", "Hardware Team"] },
  { id: "farid", accountId: "farid.tech", password: "2222", name: "Farid", roles: ["Technician", "Hardware Team"] },
  { id: "noyon", accountId: "noyon.tech", password: "2222", name: "Noyon", roles: ["Technician", "Hardware Team"] },
  { id: "arman", accountId: "arman.office", password: "2222", name: "Arman", roles: ["Admin", "Office Manager", "Hardware Team"] },
  { id: "abdurrahim", accountId: "abdurrahim.accounts", password: "2222", name: "Abdur Rahim", roles: ["Admin", "Stocks and Accounts", "Hardware Team"] },
  { id: "riyad", accountId: "riyad.repairs", password: "2222", name: "Riyad", roles: ["Technician", "Repairs", "Hardware Team"] },
  { id: "mehedi", accountId: "mehedi.tech", password: "2222", name: "Mehedi", roles: ["Technician", "Hardware Team"] },
  { id: "hena", accountId: "hena.tech", password: "2222", name: "Hena", roles: ["Technician", "Marketing", "Hardware Team"] },
  { id: "rafin", accountId: "rafin.tech", password: "2222", name: "Rafin", roles: ["Technician", "Marketing", "Hardware Team"] },
  { id: "luke", accountId: "luke.tech", password: "2222", name: "Luke", roles: ["Technician", "Hardware Team"] },
];
