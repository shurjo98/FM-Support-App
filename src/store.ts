...
export const internalAccounts: InternalAccount[] = [
  { id: "mgr1", accountId: "faisal.manager", password: "2222", name: "Mehrab", roles: ["Manager"] },
  { id: "tech1", accountId: "rashed.tech", password: "2222", name: "Rashed", roles: ["Technician"] },
  { id: "tech2", accountId: "nila.tech", password: "2222", name: "Nila", roles: ["Technician"] },
  { id: "admin1", accountId: "FM", password: "2222", name: "Lucy", roles: ["Admin", "GM"] },
  { id: "farhad", accountId: "farhad.manager", password: "2222", name: "Farhad", roles: ["Manager"] },
  { id: "manna", accountId: "manna.tech", password: "2222", name: "Manna", roles: ["Technician", "Stock Maintenance", "After-Sales Support"] },
  { id: "alamin", accountId: "alamin.manager", password: "2222", name: "Al Amin", roles: ["Manager"] },
  { id: "shaon", accountId: "shaon.service", password: "2222", name: "Shaon", roles: ["Manager", "Head of Service"] },
  { id: "liton", accountId: "liton.tech", password: "2222", name: "Liton", roles: ["Technician"] },
  { id: "bashu", accountId: "bashu.tech", password: "2222", name: "Bashu", roles: ["Technician"] },
  { id: "hares", accountId: "hares.mechanic", password: "2222", name: "Hares", roles: ["Technician", "Senior Mechanic"] },
  { id: "jashim", accountId: "jashim.mechanic", password: "2222", name: "Jashim", roles: ["Technician", "Senior Mechanic"] },
  { id: "selim", accountId: "selim.tech", password: "2222", name: "Selim", roles: ["Technician"] },
  { id: "farid", accountId: "farid.tech", password: "2222", name: "Farid", roles: ["Technician"] },
  { id: "noyon", accountId: "noyon.tech", password: "2222", name: "Noyon", roles: ["Technician"] },
  { id: "arman", accountId: "arman.office", password: "2222", name: "Arman", roles: ["Admin", "Office Manager"] },
  { id: "abdurrahim", accountId: "abdurrahim.accounts", password: "2222", name: "Abdur Rahim", roles: ["Admin", "Stocks and Accounts"] },
  { id: "riyad", accountId: "riyad.repairs", password: "2222", name: "Riyad", roles: ["Technician", "Repairs"] },
  { id: "mehedi", accountId: "mehedi.tech", password: "2222", name: "Mehedi", roles: ["Technician"] },
  { id: "hena", accountId: "hena.tech", password: "2222", name: "Hena", roles: ["Technician", "Marketing"] },
  { id: "rafin", accountId: "rafin.tech", password: "2222", name: "Rafin", roles: ["Technician", "Marketing"] },
  { id: "luke", accountId: "luke.tech", password: "2222", name: "Luke", roles: ["Technician"] },
];
